...
def data(request):
    ...
    if  bmi2[1]==1:
        ...
        yoga6="Dhanurasana."
        wedis="You need to gain your weight"
    elif bmi2[1]==2:
        ex1="Weight training"
...
def dashboard(request):
    ...
    if len(dataa) > 0:
        ...
        '''-------------------------------------------------------------------------------------''' 
        context={"dat":dataa,"symval":sumval,"weival":weival,"wedis":bmi2[0],"die":userdies[0],"cal":val,"breakfast":dietplan4[0] ,"lunch":dietplan4[1],"snack":dietplan4[2],"Dinner":dietplan4[3],"userval": "User"}

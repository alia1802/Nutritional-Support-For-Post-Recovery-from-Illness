...
lethary = int(input("Lethargy for yes(1) no(0)  :-"))
if lethary==1:
    lethary2 = 3
...
bmi=weight/(h*h)
if bmi<18.5 :
    print("You are in stage of Under Weight")
if 18.5<bmi<24.9 :
    print("You are in stage of Normal Weight")
if 25<bmi<29.9 :
    print("You are in stage of Over Weight")
if 30<bmi<34.9 :
    print("You are in stage of OBESE Weight")
if 30<bmi>34.9 :
    print("You are in stage of Extremely Obese Weight")

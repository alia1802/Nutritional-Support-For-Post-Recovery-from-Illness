...
class cal:
    ...
    def Bmi(bmi):
        if bmi<18.5 :
            a = "You are in the stage of Under Weight"
            b=1
        if 18.5<bmi<24.9 :
            a = "You are in the stage of Normal Weight"
            b = 2
        if 25<bmi<29.9 :
            a = "You are in the stage of Over Weight"
            b=0
        if 30<bmi<34.9 :
            a = "You are in the stage of OBESE Weight"
            b=0
        if 30<bmi>34.9 :
            a = "You are in the stage of Extremely Obese"
            b=0   
        return a,b
    ...
    def break_lunch_dinner(cal):
        ...
        print("calories to take in break :",break1,"to",break2," cal")
        get.append([break1,break2])

        print(" Afternoon 1 p.m.")
        lunch1=int(35*cal/100)
        lunch2= int(41 * cal / 100)
        print("calories to take in lunch :",lunch1,"to",lunch1," cal")
        get.append([lunch1,lunch2])

        print(" Night 7 p.m.")
        dinner1 =int(27*cal/100)
        dinner2 = int(33 * cal / 100)
        print("calories to take in dinner :",dinner1,"to",dinner2 ," cal")
    ...
    def break_lunch_aftersnack_dinner(cal):
        ...
        print("calories to take in lunch :",lunch1,"to",lunch2," cal")
        get.append([lunch1,lunch2])

        print(" Evening 4 p.m.")
        asnack1 = int(5 * cal / 100)
        asnack2 = int(10 * cal / 100)
        print("calories to take in afternoon snack :", asnack1, "to", asnack2, " cal")
    ...
    def break_morsnack_lunch_aftersnack_dinner(cal):
        ...
        print("calories to take in morning snack :", marsnack1, "to", marsnack2, " cal")
